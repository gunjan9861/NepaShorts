                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" class="form-control" id="company_name" @error('company_name') is-invalid
                                               @enderror name="company_name" placeholder="Enter Company Name">
                                        @error('company_name')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"@error('short_description') is-invalid
                                                  @enderror name="short_description" placeholder="Enter Short Description"></textarea>
                                        @error('title')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="long_description" rows="30" class="form-control my-editor" placeholder="Enter Long Description"></textarea>
                                    </div>
                                    <div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12">
                                            ...
                                            <input type="text" class="form-control" id="company_name" @error('url') is-invalid
