                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" @error('title') is-invalid
                                               @enderror name="title" placeholder="Enter Title" value="{{ $about->title }}">
                                        @error('title')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" @error('short_description') is-invalid
                                               @enderror name="short_description" placeholder="Enter Short Description" value="{{ $about->short_description }}">
                                        @error('title')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="long_description" class="my-editor form-control" id="desc" cols="30"
                                                      rows="10">{{ $about->long_description }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12">
                                            <strong>About Type</strong>
                                            <select class="form-control" id="category_id" name="type_id">
                                                <option value="">Select Type</option>
                                                @foreach ($aboutType as $type)
                                                    <option value="{{ $type->id }}" {{ $type->id == $about->about_type_id ? 'selected' : '' }}>{{ $type->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form_group {{ $errors->has('cover_image') ? 'has-error' : '' }}">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="photo" name="photo" @error('photo') is-invalid @enderror value="{{old('cover_image', $about->image)}}">
                                            ...
                                            <div class="col-md-12 mx-2 my-3">
                                                <img id="preview-image" id ="cover_image" src="{{$about->image ? asset('storage/about_image/'.$about->image) : asset('/images/no_image/no_image_available2.jpg')}}"
