                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" class="form-control" id="title" @error('title') is-invalid
                                               @enderror name="caption_title" placeholder="Enter Title">
                                        @error('name')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" class="form-control" id="sub_title" @error('sub_title') is-invalid
                                               @enderror name="caption_sub_title" placeholder="Enter Sub Title">
                                        @error('sub_title')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="text" class="form-control" id="order" @error('order') is-invalid
                                               @enderror name="order" placeholder="Enter Order">
                                        @error('order')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                        @enderror
                                        </div>
